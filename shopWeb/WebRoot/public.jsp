...
<div class="g-doc">
    ...
    <div class="n-public">
        <form class="m-form m-form-ht" id="form" method="post" action="product_add.action" >
            <div class="fmitem">
            ...
            <div class="fmitem">
                ...
                <div class="fmipt">
                    <input class="u-ipt ipt" name="info" placeholder="2-140字符"/> 
                </div>
            </div>
            <div class="fmitem">
                <label class="fmlab">图片：</label>
                <div class="fmipt">
                    <input class="u-ipt ipt" name="imgUrl" placeholder="图片地址"/>
                </div>
            </div>
            <div class="fmitem">
